...
class DataAugmentor(object):
    ...
    def random_object_scaling(self, data_dict=None, config=None): #modification 1130
        if data_dict is None:
    ...
    def normalize_object_size(self, data_dict=None, config=None): #modification 1130
        if data_dict is None:
