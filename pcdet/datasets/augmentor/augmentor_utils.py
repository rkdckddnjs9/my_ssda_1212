...
def scale_pre_object(gt_boxes, points, gt_boxes_mask, scale_perturb, num_try=50): #modification 1130
    """
...
def normalize_object_size(boxes, points, boxes_mask, size_reses, gt_names, class_names): #modification 1130
    """
